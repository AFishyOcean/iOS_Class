 ...
 */
struct User {
    static var currentUser: User = User(userName: "randomUserName", email: "anEmail@email.com", age: 43)
    var userName: String
    var email: String
    var age: Int
 ...
 */
User.logIn(user: User(userName: "someUser", email: "secondEmail@email.com", age: 5))
