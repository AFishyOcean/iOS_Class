...
var somePlace = GPS()
print("\(somePlace.lattitude) \(somePlace.longitude)")
//:  Change `somePlace`'s latitude to 51.514004, and the longitude to 0.125226, then print the updated values.
somePlace = GPS(lattitude: 51.514004, longitude: 0.125226)
print("\(somePlace.lattitude) \(somePlace.longitude)")
...
favoriteBook.title = "An Ember in the Ashes"
favoriteBook.author = "Sabaa Tahir"
favoriteBook.pages = 446
favoriteBook.price = 13.99
