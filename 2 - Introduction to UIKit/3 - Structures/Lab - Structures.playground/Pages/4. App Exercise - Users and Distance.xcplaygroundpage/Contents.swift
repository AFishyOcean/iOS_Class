...
var user = User(name: "David", age: 18, height: 60, weight: 160, activityLevel: 7)
print("Name: \(user.name) Age: \(user.age) Height: \(user.height)in Weight: \(user.weight)lbs Activity Level: \(user.activityLevel)/10")
/*:
...
var mileTwo = Distance(feet: 5249.344)
print(mileTwo)
/*:
